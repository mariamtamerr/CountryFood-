      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="bg-black mx-auto rounded-3xl p-10">
          <div class="content text-center">
            <h6 class="text-[#FFCE42] font-medium text-sm">ابدأ رحلتك الآن</h6>
        ...
        <div class="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
          <div>
            ...
            <div class="md:mb-12 max-w-2xl">
              <p class="my-3 text-sm font-semibold">اتصل بنا</p>
              <h1 class="font-semibold text-[#D71F29] text-4xl">
                جاهز للخطوة التالية؟
              </h1>
              <p class="text-black font-semibold text-4xl">نحن هنا لمساعدتك</p>
            ...
            <div class="callUs mt-10 md:mt-auto lg:flex gap-5">
              <div
                class="black w- md:w-auto mb-3 lg:mb-0 bg-black rounded-xl p-4 flex gap-2"
              >
                <div class="icon mt-3">
                  <img
                    class="size-5"
                    src="../assets/images/phone-flip 2.png"
                    alt="phone"
                  />
                </div>
              ...
              <div
                class="gray w- md:w-auto rounded-xl p-4 flex gap-2 bg-[#4EB95314]"
              >
                <div class="icon mt-3">
                  <img
                    class="size-5"
                ...
                <div class="content">
                  ...
                  <h4 dir="ltr" class="text-lg text-[#46A64A]">
                    +966 55 478 9666
                  </h4>
                </div>
              </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      ...
                      <div class="relative col-span-full">
                        ...
                        <div
                          ...
                          class="hidden absolute z-10 w-full bg-gray-100 rounded-lg p-4 d:bg-neutral-950"
                        >
                          <div
                          ...
                          <h4
                            class="mt-3 text-sm font-semibold text-gray-800 d:text-white"
                          >
                            Your password must contain:
                          </h4>

                          <ul
                            class="space-y-1 text-sm text-gray-500 d:text-neutral-500"
                          >
                            <li
