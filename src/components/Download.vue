...
<div class="relative  ">
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <!-- start : download  -->
     <div class="bg-black mx-auto rounded-3xl  p-10">

       <div class="content text-center ">
            <h6 class="text-[#FFCE42] font-medium text-sm">
                ابدأ رحلتك الآن
            </h6>

            <h4 class="text-white text-3xl font-bold mt-3">
                اتصل بنا الآن لتنفيذ فكرتك!
            </h4>

            <h6 class="text-[#FFFFFFB2] text-sm mt-7">
                تحدث معنا لتحويل فكرتك إلى تطبيق ناجح!
            </h6>
       </div>
    ...
    <div class="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
      <div>
        ...
        <!-- Title -->
        <div class=" md:mb-12 max-w-2xl">
            <p class="my-3 text-sm font-semibold">
                اتصل بنا
            </p>
          <h1 class=" font-semibold text-[#D71F29] text-4xl">
            جاهز للخطوة التالية؟
          </h1>
          <p class="text-black font-semibold text-4xl">
            نحن هنا لمساعدتك
          </p>
          <p class="mt-10 text-xs text-[#000000B2]">
            لا تتردد في الاتصال بنا لمزيد من المعلومات حول لخدماتنا
          </p>
        ...
        <!-- Numbers -->
        <div class="callUs   mt-10 md:mt-auto lg:flex gap-5 ">
            <div  class="black w- md:w-auto mb-3 lg:mb-0 bg-black rounded-xl p-4 flex gap-2">
                <div class="icon mt-3">
                    <img class="size-5" src="../assets/images/phone-flip 2.png" alt="phone"/>
                </div>
                <div class="content" dir="">
                    <h6 class="text-xs text-[#FFFFFFB2]">اتصل بنا </h6>
                    <h4 dir="ltr" class="text-lg text-white">+966 55 478 9666</h4>    
                </div>
               
            </div>

            <div class="gray  w- md:w-auto rounded-xl p-4  flex gap-2 bg-[#4EB95314] ">
                <div class="icon mt-3">
                    <img class="size-5" src="../assets/images/whatsapp.png" alt="whatsapp"/>
                </div>
                <div class="content">
                    <h6 class="text-xs text-[#46A64A]">اتصل بنا </h6>
                    <h4 dir="ltr" class="text-lg text-[#46A64A]">+966 55 478 9666</h4>    
                </div>
          ...
          <div class="lg:max-w-lg  lg:mx-auto lg:me-0 ms-auto">
            ...
            <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-neutral-900">
              ...
              <div class="mt-5">
                  ...
                  <!-- End Input Group -->
                    ...
                    <div class="relative">
                      ...
                      peer-focus:scale-90
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">رقم الجوال</label>
                    </div>
                    <!-- End Floating Input -->
                  ...
                  <div class="relative col-span-full">
                    ...
                    <div class="relative">
                      ...
                      peer-focus:scale-90
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">البريد الالكتروني</label>
                    </div>
                    <!-- End Floating Input -->
                  </div>
                  <!-- End 3rd Input Group -->
                  ...
                  <div class="col-span-full">
                    ...
                    <div class="relative">
                      ...
                      peer-focus:scale-90
                        ...
                        peer-[:not(:placeholder-shown)]:translate-x-0.5
                        peer-[:not(:placeholder-shown)]:-translate-y-1.5
                        peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">الرسالة</label>
                    </div>
                    <!-- End Floating Input -->
                  </div>
                  <!-- End 4th Input Group -->
                ...
                <div class="mt-5">
                  <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-full border border-transparent bg-[#D71F29] text-white hover:bg-[#e63740] focus:outline-none focus:bg-[#e63740] disabled:opacity-50 disabled:pointer-events-none">
                    ابدأ الآن
                </button>
                </div>
              </div>
