...
<div class="max-w-[85rem] bg-[#FAFAFA] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
    ...
    <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">ماذا نقدم لك؟</h2>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
    ...
    <!-- Card -->
    <a class="group  hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition dark:hover:bg-white/10 dark:focus:bg-white/10" href="#">
      <div class="aspect-w-16 aspect-h-10 ">
        <img class="w- mx-auto object-cover rounded-xl" src="../assets/images/layer 1.png" alt="Layer Image">
      </div>
    ...
    <a class="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition dark:hover:bg-white/10 dark:focus:bg-white/10" href="#">
      <div class="aspect-w-16 aspect-h-10">
        <img class="w- mx-auto object-cover rounded-xl" src="../assets/images/responsive 1.png" alt="Responsive Image">
      </div>
      <h3 class="mt-5 text-lg text-center font-bold text-gray-800 dark:text-neutral-300 dark:hover:text-white">
    ...
    <a class="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition dark:hover:bg-white/10 dark:focus:bg-white/10" href="#">
      <div class="aspect-w-16 aspect-h-10">
        <img class="w- mx-auto object-cover rounded-xl" src="../assets/images/settings 1.png" alt="Settings Image">
      </div>
      <h3 class="mt-5 text-lg text-center font-bold text-gray-800 dark:text-neutral-300 dark:hover:text-white">
        نظام إدارة الطلبات المتكامل
      </h3>
    ...
    <a class="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition dark:hover:bg-white/10 dark:focus:bg-white/10" href="#">
      <div class="aspect-w-16 aspect-h-10">
        <img class="w- mx-auto object-cover rounded-xl" src="../assets/images/map (1).png" alt="Map Image">
      </div>
      <h3 class="mt-5 text-lg text-center font-bold text-gray-800 dark:text-neutral-300 dark:hover:text-white">
        خرائط وتحديد الموقع
      </h3>
    ...
    <a class="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition dark:hover:bg-white/10 dark:focus:bg-white/10" href="#">
      <div class="aspect-w-16 aspect-h-10">
        <img class="w- mx-auto object-cover rounded-xl" src="../assets/images/credit-card (1).png" alt="Credit Card Image">
      </div>
      <h3 class="mt-5 text-lg text-center font-bold text-gray-800 dark:text-neutral-300 dark:hover:text-white">
    ...
    <a class="group hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-xl p-5 transition dark:hover:bg-white/10 dark:focus:bg-white/10" href="#">
      <div class="aspect-w-16 aspect-h-10">
        <img class="w- mx-auto object-cover rounded-xl" src="../assets/images/database 1.png" alt="Database Image">
      </div>
      <h3 class="mt-5 text-lg text-center font-bold text-gray-800 dark:text-neutral-300 dark:hover:text-white">
