<template>
    <div>
<!-- Card Blog -->
<div class="max-w-[85rem] -mt-56 sm:-mt-64  md:-mt-96  lg:-mt-20   px-4 py-10  lg:px-8 lg:py- mx-auto">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-8">
    <div class="lg:order-2">
      <div class="relative pt-[50%] lg:pt-[100%] rounded-lg">
        <img class="size-80  md:size-96 lg:size-auto  lg:absolute top-0 mx-auto start-0 object-cover rounded-lg" src="../assets/images/Frame4.png" alt="About Image">
      </div>
    </div>
    <!-- End Col -->
